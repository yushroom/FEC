...
#define FETexture2D(name) Texture2D name; SamplerState name##Sampler;
#define FESample(name, uv) name.Sample(name##Sampler, (uv))
#define FESampleLevel(name, uv, lod) name.SampleLevel(name##Sampler, (uv), (lod))
