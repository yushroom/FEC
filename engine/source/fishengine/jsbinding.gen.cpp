/* auto generated by codegen tools, do NOT modified this file directly*/
...
static JSValue js_fe_Texture_dimension_getter(JSContext *ctx,
                                              JSValueConst this_val) {
    JSValue ret;
    enum TextureDimension value;
    Texture *self =
        (Texture *)JS_GetOpaque2(ctx, this_val, js_fe_Texture_class_id);
    if (!self) return JS_EXCEPTION;
    value = self->dimension;
    ret = JSValueFrom<enum TextureDimension>(ctx, value);
    return ret;
}
// enum FilterMode filterMode getter
static JSValue js_fe_Texture_filterMode_getter(JSContext *ctx,
    ...
    ret = JSValueFrom<enum FilterMode>(ctx, value);
    return ret;
}
// enum FilterMode filterMode setter
static JSValue js_fe_Texture_filterMode_setter(JSContext *ctx,
    ...
    if (!self) return JS_EXCEPTION;
    enum FilterMode value;
    if (JSValueTo<enum FilterMode>(ctx, &value, val)) return JS_EXCEPTION;
    self->filterMode = value;
    return JS_UNDEFINED;
}
// enum TextureWrapMode wrapModeU getter
static JSValue js_fe_Texture_wrapModeU_getter(JSContext *ctx,
                                              JSValueConst this_val) {
    JSValue ret;
    enum TextureWrapMode value;
    Texture *self =
        (Texture *)JS_GetOpaque2(ctx, this_val, js_fe_Texture_class_id);
    if (!self) return JS_EXCEPTION;
    value = self->wrapModeU;
    ret = JSValueFrom<enum TextureWrapMode>(ctx, value);
    return ret;
}
// enum TextureWrapMode wrapModeU setter
static JSValue js_fe_Texture_wrapModeU_setter(JSContext *ctx,
    ...
    if (!self) return JS_EXCEPTION;
    enum TextureWrapMode value;
    if (JSValueTo<enum TextureWrapMode>(ctx, &value, val)) return JS_EXCEPTION;
    self->wrapModeU = value;
    return JS_UNDEFINED;
}
// enum TextureWrapMode wrapModeV getter
...
// enum TextureWrapMode wrapModeV setter
...
// enum TextureWrapMode wrapModeW getter
...
// enum TextureWrapMode wrapModeW setter
